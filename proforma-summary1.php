...
if(isset($_POST['finalconfirm'])){
    $query = "UPDATE patientregistration SET proformaSubmit='True' WHERE patientid='$pid'";
    if (mysqli_query($conn, $query)) {
        // echo "<script>alert('Data inserted into the database');</script>";
    } else {
        echo "Error: " . mysqli_error($conn);
...
echo $query;
    $practname = $data['treated_by'];


    //write redirect link here
    header("Location: next-step.php?id=$pid");
    //  . "&doc=" . $practname);
}
...
// echo $query;
    ...
    //write redirect link here
    header("Location: proforma-edit.php?id=$pid");
}
...
<body>
    ...
    <main id="main" style="margin-top: 0; padding-top:10px;">
        ...
        <section style="padding: 0px 0px;">
            ...
            <h2 style="text-align: center; margin-top: 20px;">Preview</h2>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input readonly type="text" id="locatn" value="<?php echo $data['locatn']; ?>"
                                            name="locatn">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input readonly type="text" id="duration" name="duration"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input readonly type="text" value="<?php echo $data['charactr']; ?>" name="charactr">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input readonly type="text" name="severe" id="severity" style="width: 190px;"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input readonly type="text" id="radiation" name="radiation"
                            ...
                            <div class="col">
                                <input readonly type="text" name="prevMI" id="prevMI" style="width: 190px;" value="<?php echo $data['prevMI']; ?>">
                                    <!-- <option value="None">Select</option>
                    ...
                    <div class="col box">
                        <div class="row" style="margin-top: 20px;">
                            <div class="col text-center">
                                ...
                                <!-- </div> -->
                                <textarea readonly type="text" id="aggFactor" name="aggFactor" rows="8" cols="30"
...
?>
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="col text-center">
                                ...
                                <!-- </div> -->
                                <textarea readonly type="text" id="relieveFactor" name="relieveFactor" rows="8" cols="30"
...
?>
                                <input disabled type="checkbox" id="noneTick" name="athero[]" value="None" <?php echo (strpos($data['athero'], "None")!==false) ? "checked":""; ?>>
                                <!-- onclick="check(this)"  -->
                                <label for="noneTick" style="text-align: left; padding: 1px;">None</label>
                                <br>
                                <input disabled type="checkbox" id="Peripheral arterial disease"
                                ...
                                <br>
                                <input disabled type="checkbox" id="Past MI" value="Past MI" name="athero[]" <?php echo (strpos($data['athero'], "Past MI")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="Past MI">Past MI</label>
                                <br>
                                <input disabled type="checkbox" id="Past coronary revascularization" <?php echo (strpos($data['athero'], "Past coronary revascularization")!==false) ? "checked":""; ?>
                                ...
                                <br>
                                <input disabled type="checkbox" id="Stroke" value="Stroke" name="athero[]" <?php echo (strpos($data['athero'], "Stroke")!==false) ? "checked":""; ?>>
...
?>
                                <input disabled type="checkbox" id="noneAssoc" name="assoc_comp[]" value="None" <?php echo (strpos($data['assoc_comp'], "None")!==false) ? "checked":""; ?>>
                                    <!-- onclick="check(this)"> -->
                                <label for="noneAssoc" style="text-align: left; padding: 1px;">None</label>
                                <br>
                                <input disabled type="checkbox" id="NV" name="assoc_comp[]" value="Nausea and vomiting" <?php echo (strpos($data['assoc_comp'], "Nausea and vomiting")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Nausea and vomiting</label>
                                <br>
                                <input disabled type="checkbox" id="SB" name="assoc_comp[]" value="Shortness of breath" <?php echo (strpos($data['assoc_comp'], "Shortness of breath")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Shortness of breath</label>

                                <br>
                                <input disabled type="checkbox" id="syn" name="assoc_comp[]" value="Syncope" <?php echo (strpos($data['assoc_comp'], "Syncope")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Syncope</label>

                                <br>
                                <input disabled type="checkbox" id="diaph" name="assoc_comp[]" value="Diaphoresis" <?php echo (strpos($data['assoc_comp'], "Diaphoresis")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Diaphoresis</label>

                                <br>
                                <input disabled type="checkbox" id="fever" name="assoc_comp[]" value="Fever" <?php echo (strpos($data['assoc_comp'], "Fever")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Fever</label>

                                <br>
                                <input disabled type="checkbox" id="expect" name="assoc_comp[]" value="Expectoration" <?php echo (strpos($data['assoc_comp'], "Expectoration")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Expectoration</label>

                                <br>
                                <input disabled type="checkbox" id="hemosys" name="assoc_comp[]" value="Hemoptysis" <?php echo (strpos($data['assoc_comp'], "Hemoptysis")!==false) ? "checked":""; ?>>
                                <label style="text-align: left; padding: 1px;" for="">Hemoptysis</label>

                                <br>
                                <input disabled type="checkbox" id="trauma" name="assoc_comp[]" value="Recent trauma" <?php echo (strpos($data['assoc_comp'], "Recent trauma")!==false) ? "checked":""; ?>>
...
<?php //} ?>
                                ...
                                <div class="row" style="margin-top: 10px">
                                    ...
                                    <div class="col">
                                        <textarea readonly type="text" id="oth" name="oth" value="" rows="2" cols="25" name="others2"
                ...
                <div class="row">
                    <div class="col box">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="pedal" id="pedal" style="width: 190px;" value="<?php echo $data['pedal'];?>">
                                    <!-- <option value="None">Select</option>
                                    <option value="No">No</option>
                                    <option value="Yes">Yes</option>
                                </select> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="calftend" id="calftend" style="width: 190px;" value="<?php echo $data['calftend'];?>">
                                    <!-- <option value="None">Select</option>
                                    <option value="no">No</option>
                                    <option value="yes">Yes</option>
                                </select> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="bilateral" id="bilateral" style="width: 190px;" value="<?php echo $data['bilateral'];?>">
                                    <!-- <option value="None">Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" id="abdtender" name="abdtender"
                                    value="<?php echo $data['abdomentend']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <textarea readonly type="text" id="auscult" name="auscult" rows="3" cols="30"
                        ...
                        <!-- <div class="row">
                            ...
                            <div class="col">
                                <textarea readonly type="text" id="abdtender" name="abdtender" rows="3" cols="30"
                    ...
                    <div class="col box ">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="s1" id="s1" style="width: 190px;" value="<?php echo $data['s1'];?>">
                                    <!-- <option value="none">Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="s2" id="s2" style="width: 190px;" value="<?php echo $data['s2'];?>">
                                    <!-- <option value="none">Select</option>
                                    <option value="normal">Normal</option>
                                    <option value="abnormal">Abnormal</option>
                                </select> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="s3" id="s3" style="width: 190px;" value="<?php echo $data['s3'];?>">
                                    <!-- <option value="none">Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="pericardial" id="pericardial" style="width: 190px;" value="<?php echo $data['pericardial'];?>">
                                    <!-- <option value="none">Select</option>
                                    <option value="present">Present</option>
                                    <option value="Absent">Absent</option>
                                </select> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input readonly type="text" name="murmur" id="murmur" style="width: 190px;" value="<?php echo $data['murmur'];?>">
                                    <!-- <option value="none">Select</option>
                                    <option value="present">Present</option>
                                    <option value="Absent">Absent</option>
                                </select> -->
                        ...
                        <div class="row" style="margin-top: 30px;">
                            ...
                            <div class="col">
                                <textarea readonly type="text" id="desc_abnorm" name="desc_abnorm" rows="3" cols="30"
                        ...
                        <div class="row">
                            <div class="col">
                                <label style="text-align: left; padding: 5px;" for="clinic_in"><strong>Other clinical
                                        input readonlys:</strong></label>



                            </div>
                            <div class="col">
                                <textarea readonly type="text" id="clinic_in" name="clinic_in" rows="3" cols="30"
        ...
        <section style="padding: 1px 1px">
                    ...
                    <div class="card material-table box" style="margin: auto; padding-top: 40px; width: 100%;">
                        ...
                        <table id="datatable">
                            ...
                            <tr>
                                ...
                                <td> 0 </td>
                                <th rowspan="3">
                                    <input readonly type="text" id="input1" name="history" style="background-color: #9DD;"
                                    value="<?php echo $data['history']; ?>">
                                </th>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr class="tab">
                                ...
                                <td> 0 </td>
                                <th rowspan="3">
                                    <input readonly type="text" id="input2" name="ecg" readonly style="background-color: #9DD;"
                                    value="<?php echo $data['ecg'];?>">
                                </th>
                            </tr>
                            <tr class="tab">
                                <td>
                            ...
                            <tr>
                                ...
                                <td> 0 </td>
                                <th rowspan="3">
                                    <input type="text" id="input3" name="cal_age" readonly style="background-color: #9DD;"
                                    value="<?php echo $data['cal_age'];?>">
                                </th>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr class="tab">
                                ...
                                <td> 0 </td>
                                <th rowspan="4">
                                    <input type="text" id="input4" name="cv_risk" readonly style="background-color: #9DD;"
                                    value="<?php echo $data['cv_risk'];?>">
                                </th>
                            </tr>
                            <tr class="tab">
                                <td>
                            ...
                            <tr>
                                ...
                                <th>
                                    <input type="text" id="totalScore" name="total" readonly style="background-color: #9DD;"
                    ...
                    <div class="col box">
                        ...
                        <div class="row text-center">
                            <div class="col">
                             ...
                             <!-- height: 200px; width: 200px; margin-top: 20px; margin-bottom: 20px; margin-right: 20px;margin-left: 20px; background-color: #F5FAFF" -->
                                    <img src="<?php echo "uploads/".$pid."/".$pid.".jpg" ?>" id="output"  style="display: ;margin: 10px; padding: 10px;" height="300px" width="300px;" class="box">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container" style="margin: auto; padding-top: 30px">
                <div class="row align-items-center">
                    <div class="col text-center">
                        <input type="submit" 
                        onclick="window.location.href='proforma-edit.php?id=<?php echo $pid; ?>';"
                        class="btn btn-warning btn-lg" value="Edit" name="edit" style="width: 120px;">

                        <input type="submit" id="finalconfirm" class="btn btn-warning btn-lg" value="Confirm" name="finalconfirm"
                            style="width: 120px;">
                    </div>
                            <!-- // "window.location.hrefnext-step.php?id=<?php //echo $pid; ?>  -->
