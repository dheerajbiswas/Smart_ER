...
try {
    ...
    $query = "UPDATE patientregistration SET prescription_path='$targetFile' WHERE patientid='$pid'";
    ...
    header('Location: field-patient-list.php?token=2&doc='.$data['treated_by']);
    exit();
