...
if (isset ($_GET['doc'])) {
  $doctor = $_GET['doc'];
  $query = "SELECT * FROM patientregistration WHERE treated_by='$doctor' ORDER BY date DESC, time DESC";
  // echo $doctor . " <br> ". $query;
// } elseif($_GET['role'] === "expert") {
//   $doctor = $_GET['doc'];
//   $query = "SELECT * FROM patientregistration WHERE expertname='$doctor'";
...
<body>
  ...
  <div class="container">
    <div class="row text-center">
      ...
      <!-- <div class="col m-0"> -->
      <?php //if ($_GET['role'] === "user") {
      echo '<div class="col m-5" style="text-align: center;">
  ...
  <!-- <script>
    // Function to update div width based on table width
    function updateDivWidth() {
      var tableWidth = document.getElementById("myTable").offsetWidth;
      document.getElementsByClassName("myDiv").style.width = tableWidth + "px";
    }

    // Call the function initially
    updateDivWidth();

    // Listen for window resize events to update div width dynamically
