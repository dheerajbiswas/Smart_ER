...
<body>
    ...
    <main id="main" style="margin-top: 0; padding-top:10px;">
        ...
        <section style="padding: 0px 0px;">
            ...
            <h2 style="text-align: center; margin-top: 20px;">Patient Clinical Details</h2>
                        ...
                        <div class="row text-center">
                            <div class="col box"> -->
                             ...
                             <!-- height: 200px; width: 200px; margin-top: 20px; margin-bottom: 20px; margin-right: 20px;margin-left: 20px; background-color: #F5FAFF" -->
                                    <!-- <img src="<?php //echo "uploads/".$pid."/".$pid.".jpg" ?>" id="output"  style="display: ;">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- <div class="container" style="margin: auto; padding-top: 30px">
                <div class="row align-items-center">
                    <div class="col text-center">
                        ...
                        <input type="button" id="next" class="btn btn-warning btn-lg" value="Confirm" 
                            onclick="window.location.href='next-step.php?id=<?php //echo $pid; ?>';" #style="width: 120px;">
                    </div>
                </div>
            </div> -->
            <!-- </div> -->
