...
<body>
    ...
    <main id="main">
        <section class="about"> <!--data-aos="fade-up"> -->
            ...
            <!-- <div class="container-fluid"> -->
                ...
                <!-- <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="row"> -->
                <!-- <div class="col-2" > -->
                <p>Name: {{ patientName }}</span><br>
                <!-- </div> -->
                <!-- <div class="col-3" > -->
                <!-- <p disabled type="text" id="name" value="">
                ...
                <!-- </div> -->
                <!-- <div class="col-3"> -->
                <!-- <p disabled type="text" id="date" value="">
                ...
                <!-- <div class="row"> -->
                <!-- <div class="col-2"> -->
                <span>UHID No.: {{ patientid }}</span><br>
                <!-- </div> -->
                <!-- <div class="col-3"> -->
                <!-- <p disabled type="text" id="uhid" value="">
                ...
                <!-- <p for="time" style="text-align: left;padding: 0px;padding-right: 0px;">Time:</span> -->
                <!-- </div> -->
                <!-- <div class="col-3"> -->
                <!-- <p disabled type="text" id="time" value="">
                ...
                <!-- <div class="row"> -->
                <!-- <div class="col-2"> -->
                <span>Age/Sex: {{ age/sex }}</span><br>
                <!-- </div> -->

                <!-- <div class="col-3"> -->
                <!-- <p disabled type="text" id="age_sex" value="">
                ...
                <!-- <div class="row" >  -->
                <span>Field Practitioner: Dr. {{ treated_by }}</span><br>
                <!-- <div class="col-2"> -->
                <span>Hospital: {{ hospital }}</span><br>
                <!-- </div> -->

                <!-- <div class="col-3"> -->
                <!-- <p disabled type="text" id="treated_by" value="">
                    <?php //echo $data['treated_by']; ?>{{ treated_by }}
                </span><br> -->
                <!-- </div> -->
                <!-- </div>
                    </div> -->
            ...
            <!-- <br> -->
            <span>Expert's Name: Dr. {{ expertname }}</span><br>
            <span>MCI reg. no.: {{ mcino }}</span><br>
            <span>Designation: {{ speciality }}</span><br>
            <span>Hospital: {{ experthospital }}</span><br><br>
            <span><strong>Expert's impression:</strong></span><br>
            <span> {{ impression }}</span><br><br>
            <span><strong>Expert advice:</strong></span><br>
            <span> {{ prescription }}</span>

            <hr>
            <p style="text-align: center;"><strong>Disclaimer: This advice is given based on tele-consultation. The
                    discretion of the attending physician will be final.</strong></p>
            <div class="row">
                <!-- <div class="col-2">
                    </div> -->
