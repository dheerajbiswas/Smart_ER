...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO login (username,password, salute, Name, Council_registration, hospital, phone_no, whatsapp_no, email, speciality, role) 
              VALUES ('$username', '$password', '$salutation', '$Name', '$Council_registration', '$hospital', '$phone_no', '$whatsapp_no', '$email', '$speciality', 'expert')";
    ...
    <main id="main" style="margin-top: 0; padding-top:10px;">
        ...
        <section style="padding: 0px 0px;">
            ...
            <div class="container" style="margin-top: 20px;">
                ...
                <h2 style="text-align: center;">Expert Registration</h2>
            ...
            <div class="container">
                ...
                <form method="post" action="<?php //echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col">
                            <input type="text" id="Council_registration" name="Council_registration" value="" required>
                        </div>
                    </div>

                    <div class="row" style="margin-top: 10px;">
                        <div class="col">
                            <label for="speciality" style="text-align: left;">Speciality
                            </label>
                        </div>
                        <div class="col">
                            <select name="speciality" id="speciality" style="width: 190px;">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col">
                            <input type="text" value="" name="hospital" required onkeyup="capitalizeFirstLetter(this)">
                        </div>
                    </div>

                    <div class="row" style="margin-top: 10px;">
                        <div class="col">
                            <label for="phone" style="text-align: left;">Phone No.:
                            </label>
                        </div>
                        <div class="col">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col">
                            <label for="whatsapp" style="text-align: left;">Whatsapp No.:
                            </label>
                        </div>
                        <div class="col">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col">
                            <input type="text" value="" id="username" name="username" style="margin-top:5px;" required>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col">
                            <input type="password" id="confirmpass" value="" name="confirmpass" required>
