            ...
            <div class="container">
                <div class="col p-0">
                    ...
                    <div class="row ">
                        ...
                        <div class="col box text-center">
                            ...
                            <div class="row">
                                <div class="col">
                                    <!-- <label for="viewecg">View ECG:</label></div> -->
                                    <input type="button" class="btn btn-primary" target="_blank"
                                        ...
                                        id="clinical" style="width: 100%;max-width: 300px;border-radius: 0.0em; margin-top: 10px;"
                                        value="View clinical details">
                                    <script>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="button" class="btn btn-primary" name="Click" id="viewecg"
                                        style="width: 100%;max-width: 300px;border-radius: 0.0em; margin-top: 10px; " target="_blank"
                                        onclick="window.location.href='uploads/421/421.jpg'" value="View ECG">
                                    <script>
                            ...
                            <div class="row">
                                <div class="col">
                                    <!-- <label for="viewecg">View ECG:</label></div> -->
                                    <input type="button" class="btn btn-primary" id="field_prescription"
                                        style="width: 100%;max-width: 300px;border-radius: 0.0em; margin-top: 10px;" target="_blank"
                                        <?php echo $data['stat'] === "Pending" ? "disabled" : ""; ?>
                                        value="View field side prescription">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="button" class="btn btn-primary" id="expert_prescription"
                                        ...
                                        value="View expert prescription">
                                    <!-- onclick="window.location.href='uploads/421/patientdetails.pdf'"  -->
                                    <script>
                            ...
                            <p><label for="interview">View field practitioner's prescription:</label></p>
                        ...
                        <!-- <p> <input type="button" id="field_prescription" style="width: 250px;" target="_blank" 
                                <?php //echo $data['stat'] === "Pending"? "disabled": ""; ?> value="View field practitioner's prescription"> -->
                        <!-- onclick="window.location.href='uploads/421/patientdetails.pdf'"  -->
                        <!-- </p> -->
                        <!-- <script>
                                document.getElementById("field_prescription").onclick = function () {
                        ...
                        <!-- <p> <input type="button" id="expert_prescription" style="width: 250px;" target="_blank" 
                            <?php //echo $data['expertOpinion'] === "Pending"? "disabled": ""; ?> value="View your prescription"> -->
                        <!-- onclick="window.location.href='uploads/421/patientdetails.pdf'"  -->
                        <!-- </p>
                            <script>
                                document.getElementById("expert_prescription").onclick = function () {
                ...
                <div class="col text-center">
                        <input type="button" id="SaveComplain" class="btn btn-warning btn-lg" data-toggle="modal"
                            data-target="#"
                            onclick="window.location.href='patient-list.php?doc=<?php echo $data['expertname'] ?>';"
                            value="Go Back">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col" style="text-align: center;">
                                            ...
                                            <textarea type="text" id="diagnosis" name="diagnosis" value="" cols="70"
                                    ...
                                    <div class="row">
                                        <div class="col" style="text-align: center;">
                                            ...
                                            <textarea type="text" id="prescibe" name="prescibe" value="" cols="70"
                                    ...
                                    <div class="row">
                                        <div class=" col text-center">
                                            <button type="submit" id="download" name="download" class="btn btn-warning"
                                                value="Save">Download</button>
